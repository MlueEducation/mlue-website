  ...
  return (
    <section className="hero" style={{ paddingBottom: 120 }}>
      ...
      <div className="hero-inner">
        ...
        <p>Platforma açılanda ilk bilənlərdən ol və erkən qeydiyyat endirimindən yararlan. Hesab yaratmaq istəyirsənsə, birbaşa <a href="/qeydiyyat" style={{ color: 'var(--accent)', fontWeight: 600 }}>qeydiyyat</a> səhifəsinə keçə bilərsən.</p>
        <Reveal>
