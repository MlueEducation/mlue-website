...
export default function NotificationBell() {
  ...
  return (
    <div className="relative" ref={ref}>
      ...
      <div className={`absolute right-0 mt-2 w-80 max-w-[90vw] rounded-2xl bg-[var(--bg-surface)] border border-[var(--border)] shadow-[var(--shadow-lg)] overflow-hidden z-50 dropdown-panel ${open ? 'open' : ''}`}>
